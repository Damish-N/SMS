    ...
    <form id="upload_marks" class="col-12 d-flex justify-content-center" method="POST" enctype="multipart/form-data" action="<?php echo set_url("marks/classroom/view/$classroom_id/$t"); ?>">
        <div class="col-10 flex-col" style="overflow-x: scroll;overflow-y: hidden;">
            <table class="table-strip-dark">
                <caption class="p-5"><b>Student Marks<br><?php if (isset($classroom_data['grade'])) {
                                                                echo 'Grade-' . $classroom_data['grade'] . $classroom_data['class'];
                                                            } ?><br><?php if (isset($y)) {
                                                                                                                                                                                echo 'Year-' . $y;
                                                                                                                                                                            } ?><br><?php if (isset($t)) {
                                                                                                                                                                                                                            echo 'Exam-' . $t;
                ...
                <tbody id="tbody" class="p-1">
                    ...
                    ?>
                            <tr>
                                ...
                                foreach ($subject_list as $subject) {
                                ?>
                                    <td><input type="text" name="<?php echo $student['id'] . '-' . $subject['id']; ?>" id="<?php echo $student['id'] . '-' . $subject['id']; ?>" placeholder="" value="<?php if (isset($std_marks[$student['id'] . '-' . $subject['id']])) {
                                                                                                                                                                                                    echo $std_marks[$student['id'] . '-' . $subject['id']];
                                                                                                                                                                                                } ?>" maxlength="3" disabled></td>
                                <?php
                                }
        ...
        if ($_SESSION['role'] == 'admin') {
            ...
            echo '<input type="submit" name="submit" id="submit"  class="btn btn-blue m-1">';
            echo '</div>';
        }
        ?>
    </form>
    <!-- classroom exam graphs -->
