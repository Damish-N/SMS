					...
					<div>
						<?php if (isset($show_notice_board) && ($show_notice_board === 1)) { ?>
							...
							<div class="col-12" id="classroom_notice_board">
								<!-- NOTICE 1 -->
								<input type="hidden" name="notice_classroom_id" id="notice_classroom_id" value="<?php if (isset($notice_classroom_id)) {
																													echo $notice_classroom_id;
																												} ?>">
								<?php
								...
								?>
											<div id="noticeboard_title" class="w-100">
												<h3><?php if (isset($notice['grade']) && !empty($notice['grade'])) {
														echo "{$notice['grade']}-{$notice['class']}";
													} ?> Notice Board</h3>
					...
					<div data-index="0" class="notice d-block col-12 d-block">
						<div id="noticeboard_title" class="w-100">
							<?php if ($_SESSION['role'] !== 'parent') { ?>
								<h3><?php if (isset($grade) && !empty($grade)) {
											echo "{$grade}-{$class}";
										} ?> Notice Board</h3>
							<?php 	} else { ?>
			...
			<div class="col-12 flex-col justify-content-center align-items-center ">
				...
				<div class="d-flex justify-content-center align-items-center">
					<form id="teacher_attendance_filter" class="d-flex align-items-center col-12">
						<div class="d-flex col-12 align-items-center justify-content-center">
							<input type="hidden" name="teacher_id" value="<?php if (isset($teacher_id)) {
																				echo $teacher_id;
																			} ?>">
							<div class="mt-5">
						...
						<tbody id="tbody">
							...
							?>
									<tr>
										...
										<td><?php if ($result_set[$i]['attendance'] == 1) {
												echo 'Present';
											} else {
												echo "Absent";
											} ?></td>
				...
				<div class="col-10 mt-5">
					...
					<form id="teacher_attendance_overview" class="col-12">
						<input type="hidden" name="teacher_id_bar" value="<?php if (isset($teacher_id)) {
																				echo $teacher_id;
																			} ?>">
